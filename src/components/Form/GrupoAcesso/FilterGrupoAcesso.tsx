...
import { IFiltersGrupoAcesso, GrupoAcessoOptions, IGrupoAcesso } from "../../../models/GrupoAcessoModel";
...
interface FormFilterAgremiacaoProps {
  values?: IFiltersGrupoAcesso;
  indexValues?: number;
}

export function FormFilterGrupoAcesso({
  values,
  indexValues,
  ...
  const { filtersAgremiacao, setFiltersAgremiacao } = useGrupoAcessoProvider();
    ...
    onSubmit: (values: IFiltersGrupoAcesso) => {
      ...
      setFiltersAgremiacao(
        newArrayFiltersWithoutSort.sort(
          (a: IFiltersGrupoAcesso, b: IFiltersGrupoAcesso) =>
    ...
    return (
      <form>
        ...
        >
          ...
          >
            {GrupoAcessoOptions.GrupoAcessoParenthesesValues.initial.map(
          ...
          >
            {GrupoAcessoOptions.GrupoAcessoHeaderValues.map((item) => (
          ...
          >
            {GrupoAcessoOptions.GrupoAcessoOperatorsValues.operator.map(
              (operator) => (
          ...
          >
            {GrupoAcessoOptions.GrupoAcessoParenthesesValues.final.map(
              (parentheses) => (
                <MenuItem value={parentheses.value}>
                  {parentheses.label}
                </MenuItem>
          ...
          >
            {GrupoAcessoOptions.GrupoAcessoOperatorsValues.logicOperator.map(
              (operator) => (
                <MenuItem value={operator.value}>{operator.label}</MenuItem>
              )
            )}
        ...
        >
          ...
          >
            {!isColumnDate
              ...
              : GrupoAcessoOptions.GrupoAcessoOperatorsValues.operatorData.map(
                  (operator) => (
                    <MenuItem value={operator.value}>{operator.label}</MenuItem>
                  )
                )}
